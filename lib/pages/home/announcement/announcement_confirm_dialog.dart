                ...
                child: new Container(
                  ...
                  child: new Row(
                    children: [
                      ...
                      new Text("Advisors are not given the Member role by default, so your advisors may not\nrecieve this announcement.", style: TextStyle(color: Colors.orangeAccent),)
                    ],
                  ),
                ),
              ),
                  ...
                  onPressed: () {
                    if (announcement.topics.isNotEmpty) {
                      if (announcement.official) {
                        fb.database().ref("announcements").push().set({
                        ...
                        fb.database().ref("chapters").child(announcement.author.chapter.chapterID).child("announcements").push().set({
                          "title": announcement.title,
                          "desc": announcement.desc,
                          "date": DateTime.now().toString(),
                          "author": announcement.author.userID,
