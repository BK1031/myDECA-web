                                ...
                                child: new Container(
                                  ...
                                  child: new Column(
                                    ...
                                    children: [
                                      ...
                                      new Visibility(visible: (score == -1 && doneViewing) || (score == -1 && DateTime.now().isAfter(startTime)), child: new Text("Joining Instructions:\n\nWhen you join the zoom room, you will need to send a message similar to the following in the chat so that you can be moved into the correct breakout room for your judge.\n", style: TextStyle(fontSize: 17))),
                                      new Visibility(visible: (score == -1 && doneViewing) || (score == -1 && DateTime.now().isAfter(startTime)), child: new SelectableText("Team ID: ${roleplayTeamID} [${selectedRoleplay}] ${currUser.firstName} ${currUser.lastName}, Judge: ${judge.firstName} ${judge.lastName} @ ${DateFormat("jm").format(startTime)}", style: TextStyle(fontFamily: "Courier New", fontSize: 17),)),
                                      new Padding(padding: EdgeInsets.all(8),),
                                      new Visibility(
