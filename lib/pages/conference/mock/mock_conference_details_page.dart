...
class MockConferenceDetailsPage extends StatefulWidget {
  ...
  @override
  _MockConferenceDetailsPageState createState() =>
      _MockConferenceDetailsPageState(this.id);
}
...
class _MockConferenceDetailsPageState extends State<MockConferenceDetailsPage> {
          ...
          fb
            ...
            if (event.snapshot.val()["roleplay"] != null) {
              ...
              await fb
                  ...
                  .child(conference.conferenceID)
                  .child("teams")
                  .child(event.snapshot.val()["roleplay"])
                  .once("value")
                  .then((value) {
                if (value.snapshot.val()["roleplay"] != null) {
                  mcUser.roleplayEvent = value.snapshot.val()["roleplay"];
                  mockConferenceEvents.forEach((key, value) {
                    if (value.contains(mcUser.roleplayEvent))
                      mcUser.roleplayEvent += " - $key";
                  });
                }
              });
            }
            setState(() {
              ...
              usersTable
                  .sort((a, b) => a.user.firstName.compareTo(b.user.firstName));
            });
          });
        });
        fb
          ...
          fb
            ...
            if (value.snapshot.val() != null) {
              fb
                  .database()
                  .ref("users")
                  .child(value.snapshot.val()["judge"])
                  .once("value")
                  .then((value) {
  ...
  void getSchedule() {
    ...
    if (roleplayTeamID != "") {
      fb
          ...
          .then((value) {
        setState(() {
          roleplayTime = DateTime.parse(value.snapshot.val()["time"])
            ...
            if (team.snapshot.val()["roleplay"] != null) {
              ...
              ids.forEach((element) {
                fb
                    ...
                    .then((value) {
                  mcUser.roleplayTeam
                      .add(new User.fromSnapshot(value.snapshot));
                });
              });
            }
            if (team.snapshot.val()["scores"] != null) {
  ...
  void confirmRegistration() {
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              content: new Text(
                  "Are you sure you want to register with the following events?\n\nWritten: $selectedWritten\nRoleplay: $selectedRoleplay\n\nYou will not be able to change events after you register.",
                  style: TextStyle(color: currTextColor)),
              actions: [
                new FlatButton(
                    ...
                    onPressed: () {
                      if (!writtenRegistered) {
                        ...
                        fb
                            ...
                            .child("teams")
                            .child(writtenTeamID)
                            .update({"written": selectedWritten});
                      ...
                      if (!roleplayRegistered) {
                        fb
                            ...
                            .child("users")
                            .child(currUser.userID)
                            .update({"roleplay": roleplayTeamID});
                        fb
                            .database()
                            .ref("conferences")
                            .child(conference.conferenceID)
                            .child("teams")
                            .child(roleplayTeamID)
                            .update({"roleplay": selectedRoleplay});
  ...
  void exportUserTrackingCsv() {
    String teamsCsv =
        "First Name,Last Name,Email,Written Event,Written Team,Written Score,Roleplay Event,Roleplay Team,Roleplay Score,Test,Test Score\n";
    userTracking.forEach((element) {
      teamsCsv +=
          "${element.user.firstName},${element.user.lastName},${element.user.email},${element.writtenEvent},";
      ...
      teamsCsv +=
          ",${element.roleplayScore},${element.testName},${element.testScore}\n";
    });
    print(teamsCsv);
    Clipboard.setData(new ClipboardData(text: teamsCsv));
  }
  ...
  void exportRankings() {
    ...
    rankTracking.forEach((element) {
      teamsCsv +=
          "${element.teamID},${element.judge.firstName} ${element.judge.lastName},";
      element.users.forEach((user) {
        teamsCsv += "${user.firstName} ${user.lastName} - ";
      });
    ...
    uploadInput.onChange.listen((e) {
      ...
      if (files.length == 1) {
        ...
        reader.onLoadEnd.listen((e) async {
          ...
          await fb
              .storage()
              .ref("conferences/2020-VC-Mock/writtens/$writtenTeamID.pdf")
              .put(file)
              .future
              .then((fb.UploadTaskSnapshot snapshot) async {
        ...
        alert(
            "Please make sure that the file you are submitting is less than 25mb and is a PDF.");
      }
    });
  }
                      ...
                      new Expanded(
                        child: Container(
                          child: new Text(
                            "${conference.desc}",
                            style:
                                TextStyle(fontSize: 17, color: currTextColor),
                          ),
                        ),
                      ),
                      Container(
                  ...
                  child: new Container(
                    ...
                    child: new Column(
                        ...
                        children: [
                          ...
                          new Text(
                              "We have successfully completed the first DECA Mock Conference at Valley Christian! A huge shout-out to all the students, mentors, and judges who helped to ensure that this was all possible.",
                      ...
                      child: new Column(
                        ...
                        children: [
                          ...
                          new Padding(
                              ...
                              child: new Divider(
                                  color: currDividerColor, height: 8)),
                          new Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              new Text(
                                "Thank you for helping judge our first mock conference!",
                        ...
                        children: [
                          ...
                          new ListTile(
                            ...
                            leading: new Text(
                              "11:00 AM",
                              style: TextStyle(
                                  color: mainColor, fontFamily: "Gotham"),
                            ),
                            trailing: new Icon(
                            ...
                            onTap: examOpen
                                ? () {
                                    router.navigateTo(context,
                                        "/conferences/${conference.conferenceID}/testing",
                                        replace: true,
                                        clearStack: true,
                                        transition: TransitionType.fadeIn);
                                  }
                          ...
                          new Visibility(
                            visible: writtenTeamID != "" &&
                                writtenTime.isBefore(roleplayTime),
                            child: new ListTile(
                              title: new Text(
                                  "Written Presentation – " + selectedWritten),
                              leading: new Text(
                                DateFormat("jm").format(writtenTime),
                                style: TextStyle(
                                    color: mainColor, fontFamily: "Gotham"),
                              ),
                              trailing: new Icon(
                              ...
                              onTap: () {
                                router.navigateTo(context,
                                    "/conferences/${conference.conferenceID}/written",
                                    transition: TransitionType.fadeIn);
                              },
                            ),
                          ),
                          new Visibility(
                            ...
                            child: new ListTile(
                              title: new Text("Roleplay Presentation – " +
                                  selectedRoleplay),
                              leading: new Text(
                                DateFormat("jm").format(roleplayTime),
                                style: TextStyle(
                                    color: mainColor, fontFamily: "Gotham"),
                              ),
                              trailing: new Icon(
                              ...
                              onTap: () {
                                router.navigateTo(context,
                                    "/conferences/${conference.conferenceID}/roleplay",
                                    transition: TransitionType.fadeIn);
                              },
                            ),
                          ),
                          new Visibility(
                            visible: writtenTeamID != "" &&
                                writtenTime.isAfter(roleplayTime),
                            child: new ListTile(
                              title: new Text(
                                  "Written Presentation – " + selectedWritten),
                              leading: new Text(
                          ...
                          new Visibility(
                            visible: writtenTeamID != "" &&
                                writtenTime.isAtSameMomentAs(roleplayTime),
                            child: new ListTile(
                              title: new Text(
                                  "Written Presentation – " +
                                      selectedWritten +
                                      " (conflict with roleplay)",
                                  style: TextStyle(color: Colors.red)),
                              leading: new Text(
                                DateFormat("jm").format(writtenTime),
                                style: TextStyle(
                                    color: Colors.red, fontFamily: "Gotham"),
                              ),
                              trailing: new Icon(
                                Icons.arrow_forward_ios,
                                color: mainColor,
                                ...
                                children: [
                                  Expanded(
                                    child: new FlatButton(
                                      child: new Text("AUDIT LOG",
                                          style: TextStyle(
                                              fontFamily: "Montserrat",
                                              color: activeTrackingTab == "Log"
                                                  ? Colors.white
                                                  : currTextColor)),
                                      color: activeTrackingTab == "Log"
                                          ? mainColor
                                  ...
                                  Expanded(
                                    child: new FlatButton(
                                      child: new Text(
                                          "USERS (${userTracking.length})",
                                          style: TextStyle(
                                              fontFamily: "Montserrat",
                                              color: activeTrackingTab == "User"
                                                  ? Colors.white
                                                  : currTextColor)),
                                      color: activeTrackingTab == "User"
                                          ? mainColor
                                          ...
                                          DataColumn(
                                              label: Text('Last Name',
                                                  style: TextStyle(
                                                      ...
                                                      fontSize: 17))),
                                          DataColumn(
                                              label: Text('Written Event',
                                                  style: TextStyle(
                                                      fontFamily: "Montserrat",
                                                      fontSize: 17))),
                                          DataColumn(
                                              label: Text('Written Team',
                                                  style: TextStyle(
                                                      fontFamily: "Montserrat",
                                                      fontSize: 17))),
                                          DataColumn(
                                              label: Text('Written Score',
                                                  style: TextStyle(
                                                      fontFamily: "Montserrat",
                                                      fontSize: 17))),
                                          DataColumn(
                                              label: Text('Roleplay Event',
                                                  style: TextStyle(
                                                      fontFamily: "Montserrat",
                                                      fontSize: 17))),
                                          DataColumn(
                                              label: Text('Roleplay Team',
                                                  style: TextStyle(
                                                      fontFamily: "Montserrat",
                                                      fontSize: 17))),
                                          DataColumn(
                                              label: Text('Roleplay Score',
                                                  style: TextStyle(
                                                      fontFamily: "Montserrat",
                                                      fontSize: 17))),
                                          DataColumn(
                              ...
                              : activeRegistrationTab == "Ranking"
                                  ...
                                  : new Container(
                                      child: new Column(
                                        ...
                                        children: [
                                          new Text(
                                            "Total Users: ${usersTable.length}",
                                            style: TextStyle(fontSize: 17),
                                          ),
                                          new Text(
                                            "Total Teams: ${teamsTable.length}",
                                            style: TextStyle(fontSize: 17),
                                          ),
                                          new Padding(
                                              padding: EdgeInsets.all(4)),
                                  ...
                                  Expanded(
                                    child: new FlatButton(
                                      child: new Text(
                                          ...
                                          style: TextStyle(
                                              fontFamily: "Montserrat",
                                              color: activeRegistrationTab ==
                                                      "Users"
                                                  ? Colors.white
                                                  : currTextColor)),
                                      color: activeRegistrationTab == "Users"
                                          ? mainColor
                                          : null,
                                      onPressed: () {
                                        setState(() {
                                      ...
                                      child: new Text(
                                          ...
                                          style: TextStyle(
                                              ...
                                              color: activeRegistrationTab ==
                                                  ...
                                                  ? Colors.white
                                                  : currTextColor)),
                                      color: activeRegistrationTab == "Teams"
                                          ? mainColor
                                          : null,
                                      onPressed: () {
                                        setState(() {
                      ...
                      Container(
                        ...
                        children: [
                          ...
                          new InkWell(
                            onTap: () {
                              html.window.open(
                                  "https://mydeca.org/#/home/announcements",
                                  "Alerts");
                            },
                            child: new ListTile(
                              title: new Text(
                                "Announcements",
                                style: TextStyle(
                                    color: currTextColor, fontSize: 18),
                              ),
                              trailing: new Icon(
                                Icons.arrow_forward_ios,
                                color: mainColor,
                          ...
                          new InkWell(
                            onTap: () {
                              html.window.open(
                                  "https://docs.google.com/document/d/1hXVtGV3eb3DJrUKrudHDLG8Ro-G6YS4hhChv0sZpyQk/edit?usp=sharing",
                          ...
                          new InkWell(
                            onTap: () {
                              html.window.open(
                                  "https://docs.mydeca.org/user/mock-conference",
                                  "Documentation");
                            },
                            child: new ListTile(
                              title: new Text(
                          ...
                          new InkWell(
                            onTap: () {
                              html.window.open(
                                  "https://us02web.zoom.us/j/81202379649?pwd=dHFxYjB6YkRyN3pkbTR4OUN4VFlkUT09",
                                  "Support Room");
                            },
                            child: new ListTile(
                              title: new Text(
