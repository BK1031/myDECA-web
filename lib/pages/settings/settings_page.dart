  ...
  void stopNotifDialog(String type) {
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              title: new Text(
                "Stop Receiving ${type == "mobilePush" ? "Push" : (type == "webPush" ? "Web" : "Email")} Notifications?",
                style: TextStyle(color: currTextColor),
              ),
              content: new Text(
                  "Are you sure you want to stop receiving these notifications? You may miss important announcements, meeting updates, and conference information.",
                  style: TextStyle(color: currTextColor)),
              actions: [
                new FlatButton(
                          ...
                          children: <Widget>[
                            ...
                            new ListTile(
                              title: new Text(
                                "Email",
                                style: TextStyle(
                                    fontSize: 17, color: currTextColor),
                              ),
                              trailing: new Text(currUser.email,
                                  style: TextStyle(
                                      fontSize: 17, color: currTextColor)),
                            ),
                            new ListTile(
                              title: new Text("User ID",
                                  style: TextStyle(
                                      fontSize: 17, color: currTextColor)),
                              trailing: new Text(currUser.userID,
                                  style: TextStyle(
                                      fontSize: 14.0, color: currTextColor)),
                            ),
                            new ListTile(
                              title: new Text(
                                "Update Profile",
                          ...
                          children: <Widget>[
                            ...
                            new ListTile(
                              ...
                              trailing: new Icon(Icons.arrow_forward_ios,
                                  color: mainColor),
                              onTap: () {
                                router.navigateTo(context, '/settings/about',
                            ...
                            new ListTile(
                                title: new Text("Export Personal Information",
                                    style: TextStyle(
                                        fontSize: 17, color: currTextColor)),
                                trailing: new Icon(Icons.arrow_forward_ios,
                                    color: mainColor),
                                      ...
                                      builder: (BuildContext context) =>
                                          AlertDialog(
                                            ...
                                            content: Container(
                                                width: 500,
                                                child: new Text(
                                                    "As a part of our commitment to your privacy, you may request a copy of all the personal information we have stored. This information includes, but is not limited to, user data, chapter data, announcement data, meeting data, and chat data.\n\nThis will be sent as a text file to your email within the next 6 hours.")),
                                            actions: [
                                              new FlatButton(
                                                child: new Text("CANCEL"),
                                                onPressed: () {
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            new SwitchListTile.adaptive(
                              ...
                              title: new Text("Web Notifications",
                                  style: TextStyle(
                                      fontSize: 17, color: currTextColor)),
                            ),
                            new SwitchListTile.adaptive(
                              ...
                              title: new Text("Email Notifications",
                                  style: TextStyle(
                                      fontSize: 17, color: currTextColor)),
                            ),
                            new Visibility(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            new ListTile(
                              ...
                              onTap: () async {
                                const url =
                                    'https://forms.gle/8UMH4V5Ty79qFEnNA';
                                if (await canLaunch(url)) {
                                  await launch(url);
                                } else {
                                  throw 'Could not launch $url';
                            ...
                            new ListTile(
                              ...
                              onTap: () async {
                                const url =
                                    'https://github.com/Equinox-Initiative/myDECA-flutter/issues';
                                if (await canLaunch(url)) {
                                  await launch(url);
                                } else {
                                  throw 'Could not launch $url';
                                  ...
                                  new ListTile(
                                    ...
                                    title: new Text("Test Firebase Upload",
                                        style: TextStyle(
                                            ...
                                            color: currTextColor)),
                                    onTap: () {
                                      fb.database().ref("testing").push().set(
                                          "${currUser.firstName} - ${currUser.roles.first}");
                                    },
                                  ),
                                ],
                              ),
