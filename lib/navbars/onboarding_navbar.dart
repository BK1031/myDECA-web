            ...
            Row(
              ...
              children: <Widget>[
                new FlatButton(
                  ...
                  child: new Text("JOIN BETA", style: TextStyle(fontFamily: "Montserrat", letterSpacing: 1)),
                  onPressed: () {
                ...
                new FlatButton(
                  textColor: Colors.white,
                  child: new Text("DOCUMENTATION", style: TextStyle(fontFamily: "Montserrat", letterSpacing: 1)),
                  onPressed: () {
                ...
                new FlatButton(
                  textColor: Colors.white,
                  child: new Text("DOWNLOAD", style: TextStyle(fontFamily: "Montserrat", letterSpacing: 1)),
                  onPressed: () {
                ...
                new RaisedButton(
                    ...
                    child: new Text("OPEN MYDECA", style: TextStyle(fontFamily: "Montserrat", letterSpacing: 1)),
                    textColor: Colors.white,
                    color: mainColor,
